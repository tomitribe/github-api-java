...
public class GithubClientCreatePullRequestTest {
    ...
    public static class MockGithub {
        ...
        public Response createPullRequest(@HeaderParam("authorization") final String authorization,
            ...
            final String response = Resources.read(GithubClientCreatePullRequestTest.class, "create-pull-request-response.json");
