...
public class Request<ResponseType> {
    ...
    private Request(final String path, final String body, final Map<String, Object> queryParams, final Map<String, Object> headerParams, final Map<String, Object> pathParams) {
        this.path = path;
        this.body = body;
